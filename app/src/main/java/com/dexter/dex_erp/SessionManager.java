...
public class SessionManager {
    ...
    private static final String PREF_NAME = "IERP";
    ...
    public void createLoginSession(String id, String entity_id,
                                   String login_status) {
        ...
        editor.putString(KEY_ENTITY_ID, entity_id);

        // Storing email in pref
        editor.putString(KEY_USER_STATUS, login_status);
